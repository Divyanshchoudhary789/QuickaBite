...
export const normalizeOrder = (raw) => {
  ...
  return {
    ...
    dispatchStatus: orderObj.dispatchStatus || "NOT_DISPATCHED",
    ...
    customerName: orderObj.customerName || orderObj.contactName || orderObj.user?.fullName || "",
    contactName: orderObj.contactName || orderObj.customerName || orderObj.user?.fullName || "",
